...
static const u8 sText_PkmnRaisedAttack[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY}\nraised its ATTACK!");
static const u8 sText_PkmnMadeItAttackMax[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY}\nmaximized its ATTACK!");
static const u8 sText_PkmnMadeItHpFall[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY}\nmade its HP fall!");
...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT - BATTLESTRINGS_TABLE_START] = {
    ...
    [STRINGID_PKMNRAISEDATTACK - BATTLESTRINGS_TABLE_START]              = sText_PkmnRaisedAttack,
    [STRINGID_PKMNMADEITATTACKMAX - BATTLESTRINGS_TABLE_START]           = sText_PkmnMadeItAttackMax,
    [STRINGID_PKMNMADEITHPFALL - BATTLESTRINGS_TABLE_START]              = sText_PkmnMadeItHpFall,
