...
static bool8 AccuracyCalcHelper(u16 move)
{
    ...
    (
        ...
        gBattleMoves[move].effect == EFFECT_ALWAYS_HIT_SP || 
        gBattleMoves[move].effect == EFFECT_ALWAYS_HIT_CONFUSE || 
...
static void Cmd_critcalc(void)
{
    ...
    critChance  = 2 * ((gBattleMons[gBattlerAttacker].status2 & STATUS2_FOCUS_ENERGY) != 0)
                ...
                + (gBattleMoves[gCurrentMove].effect == EFFECT_HIGH_CRITICAL && gCurrentMove == MOVE_RAZOR_LEAF)
                + (gBattleMoves[gCurrentMove].effect == EFFECT_HIGH_CRITICAL && gCurrentMove == MOVE_SLASH)
...
static void Cmd_handleballthrow(void)
{
    ...
    else
    {
        ...
        {
            if (gBattleStruct->safariCatchFactor > 20) catchRate = 255;
            else catchRate = gBattleStruct->safariCatchFactor * 1275 / 100;
        }
        else
