...
const u8 gText_PkmnAlreadyKnowsHm[] = _("{STR_VAR_1} already knows\nanother TM or HM.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_NotAble3[] = _("HAS ONE TM");
...
const u8 gText_VolcanoBadge[] = _("VOLCANOBADGE");
const u8 gText_EarthBadge[] = _("EARTHBADGE");
const u8 gText_StreamBadge[] = _("STREAMBADGE");
const u8 gText_ValorBadge[] = _("VALORBADGE");
const u8 gText_BugBadge[] = _("BUGBADGE");
const u8 gText_GhostBadge[] = _("GHOSTBADGE");
const u8 gText_CupperBadge[] = _("CUPPERBADGE");
const u8 gText_FreedonBadge[] = _("FREEDONBADGE");
const u8 gText_HeartBadge[] = _("HEARTBADGE");
