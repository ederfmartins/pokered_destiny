static const struct HealLocation sSpawnPoints[] =
{
    ...
    [SPAWN_DRAGONITE_ISLE - 1] = {MAP_GROUP(DRAGONITE_ISLE), MAP_NUM(DRAGONITE_ISLE), 6, 3},
};
...
static const u16 sWhiteoutRespawnHealCenterMapIdxs[][2] =
{
    ...
    [SPAWN_DRAGONITE_ISLE - 1] = {MAP_GROUP(DRAGONITE_ISLE), MAP_NUM(DRAGONITE_ISLE)},
};
