// We changed the order of the POKEMON so Hoenn ones are not sequential anymore.
// Anyway this cries are kind of randon and will not be called, since we moded UNKNOW cry
// to the end of the POKEMON list.
//#define HOENN_MON_SPECIES_START 277
#define HOENN_MON_SPECIES_START 201
