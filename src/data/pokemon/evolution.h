const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_PIKACHU]    = {{EVO_ITEM, 36, SPECIES_RAICHU}, {EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_RAICHU}},
    ...
    [SPECIES_VULPIX]     = {{EVO_ITEM, ITEM_FIRE_STONE, SPECIES_NINETALES}, {EVO_LEVEL, 36, SPECIES_NINETALES}},
    [SPECIES_JIGGLYPUFF] = {{EVO_LEVEL, 30, SPECIES_WIGGLYTUFF},
                            {EVO_ITEM, ITEM_MOON_STONE, SPECIES_WIGGLYTUFF},
                            {EVO_FRIENDSHIP, 0, SPECIES_WIGGLYTUFF}},
    ...
    [SPECIES_GLOOM]      = {{EVO_LEVEL, 42, SPECIES_VILEPLUME},
    ...
    [SPECIES_PRIMEAPE]   = {{EVO_LEVEL, 60, SPECIES_ANNIHILAPE}},
    [SPECIES_GROWLITHE]  = {{EVO_ITEM, ITEM_FIRE_STONE, SPECIES_ARCANINE}, {EVO_LEVEL, 36, SPECIES_ARCANINE}},
    ...
    [SPECIES_KADABRA]    = {{EVO_LEVEL, 56, SPECIES_ALAKAZAM},
                            {EVO_TRADE, 0, SPECIES_ALAKAZAM}},
    [SPECIES_MACHOP]     = {{EVO_LEVEL, 28, SPECIES_MACHOKE}},
    [SPECIES_MACHOKE]    = {{EVO_TRADE, 0, SPECIES_MACHAMP}, {EVO_LEVEL, 42, SPECIES_MACHAMP}},
    [SPECIES_BELLSPROUT] = {{EVO_LEVEL, 21, SPECIES_WEEPINBELL}},
    [SPECIES_WEEPINBELL] = {{EVO_LEVEL, 42, SPECIES_VICTREEBEL}},
    [SPECIES_TENTACOOL]  = {{EVO_LEVEL, 30, SPECIES_TENTACRUEL}},
    [SPECIES_GEODUDE]    = {{EVO_LEVEL, 25, SPECIES_GRAVELER}},
    [SPECIES_GRAVELER]   = {{EVO_TRADE, 0, SPECIES_GOLEM}, {EVO_LEVEL, 42, SPECIES_GOLEM}},
    ...
    [SPECIES_SHELLDER]   = {{EVO_ITEM, ITEM_WATER_STONE, SPECIES_CLOYSTER}, {EVO_LEVEL, 30, SPECIES_CLOYSTER}},
    ...
    [SPECIES_EXEGGCUTE]  = {{EVO_ITEM, ITEM_LEAF_STONE, SPECIES_EXEGGUTOR}, {EVO_LEVEL, 36, SPECIES_EXEGGUTOR}},
    ...
    [SPECIES_STARYU]     = {{EVO_ITEM, ITEM_WATER_STONE, SPECIES_STARMIE}, {EVO_LEVEL, 36, SPECIES_STARMIE}},
    ...
    [SPECIES_PICHU]      = {{EVO_FRIENDSHIP, 0, SPECIES_PIKACHU}, {EVO_LEVEL, 25, SPECIES_PIKACHU}},
