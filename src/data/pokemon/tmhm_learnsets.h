...
static const u32 sTMHMLearnsets[][2] =
{
    ...
    [SPECIES_SIRFETCHD]       = TMHM_LEARNSET(TMHM(TM11_SUNNY_DAY)
                                        | TMHM(TM17_PROTECT)
                                        | TMHM(TM31_BRICK_BREAK)
                                        | TMHM(TM42_FACADE)
                                        | TMHM(TM44_REST)
    ...
    [SPECIES_VIKAVOLT]        = TMHM_LEARNSET(TMHM(TM06_TOXIC)
                                        ...
                                        | TMHM(TM45_ATTRACT)
                                        | TMHM(HM02_FLY)),
    [SPECIES_CRABOMINABLE]    = TMHM_LEARNSET(TMHM(TM01_FOCUS_PUNCH)
                                        | TMHM(TM06_TOXIC)
                                        | TMHM(TM07_HAIL)
                                        | TMHM(TM08_BULK_UP)
                                        | TMHM(TM10_HIDDEN_POWER)
                                        ...
                                        | TMHM(TM46_THIEF)
                                        | TMHM(HM06_ROCK_SMASH)),
    [SPECIES_PAWMO]           = TMHM_LEARNSET(TMHM(TM01_FOCUS_PUNCH)
                                        | TMHM(TM11_SUNNY_DAY)
                                        | TMHM(TM17_PROTECT)
                                        | TMHM(TM18_RAIN_DANCE)
                                        | TMHM(TM24_THUNDERBOLT)
