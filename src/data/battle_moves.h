const struct BattleMove gBattleMoves[MOVES_COUNT] =
{
    ...
    [MOVE_BITE] =
    {
        .effect = EFFECT_FLINCH_HIT_PHYSICAL,
        .power = 60,
        .type = TYPE_DARK,
        .accuracy = 100,
        .pp = 25,
    ...
    [MOVE_SHADOW_BALL] =
    {
        .effect = EFFECT_SPECIAL_DEFENSE_DOWN_HIT_SP,
        .power = 70,
        .type = TYPE_GHOST,
        .accuracy = 100,
        .pp = 15,
    ...
    [MOVE_MAGICAL_LEAF] =
    {
        .effect = EFFECT_ALWAYS_HIT_CONFUSE,
        .power = 60,
        .type = TYPE_GRASS,
        .accuracy = 0,
        .pp = 20,
