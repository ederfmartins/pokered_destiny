...
static const u8 sGluttonyDescription[] = _("Encourages the early use of a BER.RY.");
static const u8 sAdaptabilityDescription[] = _("Powers up moves of the same type.");
static const u8 sTangledFeetDescription[] = _("Raises evasion if the PKMN is confused.");
static const u8 sQuickFeetDescription[] = _("Boosts SPEED if there is a status problem.");
static const u8 sSniperDescription[] = _("Powers up moves on critical hits.");
static const u8 sTechnicianDescription[] = _("Powers up the PKMN's weaker moves.");
static const u8 sTintedLensDescription[] = _("Powers up 'not very effective' moves.");
static const u8 sMultiscaleDescription[] = _("Reduces damage when HP is full.");
static const u8 sAnalyticDescription[] = _("Boosts move power when moving last.");
static const u8 sMoxieDescription[] = _("Boosts ATTACK after knockout.");
static const u8 sPranksterDescription[] = _("Gives priority to a status move.");
static const u8 sSolarPowerDescription[] = _("Ups SP. ATK in sunshine; HP drops.");
static const u8 sHarvestDescription[] = _("May restore a used BER.RY.");
static const u8 sHydrationDescription[] = _("Heals status if it is raining.");
