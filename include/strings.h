...
extern const u8 gText_DiaryPage[];
...
extern const u8 gText_NotAble3[];
...
extern const u8 gText_PkmnAlreadyKnowsHm[];
...
extern const u8 gText_StreamBadge[];
extern const u8 gText_ValorBadge[];
extern const u8 gText_BugBadge[];
extern const u8 gText_GhostBadge[];
extern const u8 gText_CupperBadge[];
extern const u8 gText_FreedonBadge[];
extern const u8 gText_HeartBadge[];
