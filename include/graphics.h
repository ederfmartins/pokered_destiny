...
extern const u32 gMonFrontPic_Arctbax[];
extern const u32 gMonPalette_Arctbax[];
extern const u32 gMonBackPic_Arctbax[];
...
extern const u16 gGraphics_TitleScreen_SecondMonPals[];
