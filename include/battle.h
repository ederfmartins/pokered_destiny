...
struct TrainerMonNoItemCustomMovesAbility
{
    u16 iv;
    u8 lvl;
    u16 species;
...
#define NO_ITEM_CUSTOM_MOVES_ABILITY(party) { .NoItemCustomMovesAbility = party }, .partySize = ARRAY_COUNT(party), .partyFlags = F_TRAINER_PARTY_CUSTOM_MOVESET | F_TRAINER_PARTY_ABILITY
...
union TrainerMonPtr
{
    ...
    const struct TrainerMonNoItemCustomMovesAbility *NoItemCustomMovesAbility;
