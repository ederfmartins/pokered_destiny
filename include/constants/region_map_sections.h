...
#define MAPSEC_SEVII_ISLE_6                 0x9E
#define MAPSEC_SEVII_ISLE_7                 0x9F
#define MAPSEC_SEVII_ISLE_8                 0xA0
#define MAPSEC_SEVII_ISLE_9                 0xA1
#define MAPSEC_RESORT_GORGEOUS              0xA2
#define MAPSEC_WATER_LABYRINTH              0xA3
#define MAPSEC_FIVE_ISLE_MEADOW             0xA4
#define MAPSEC_MEMORIAL_PILLAR              0xA5
#define MAPSEC_OUTCAST_ISLAND               0xA6
#define MAPSEC_GREEN_PATH                   0xA7
#define MAPSEC_WATER_PATH                   0xA8
#define MAPSEC_RUIN_VALLEY                  0xA9
#define MAPSEC_TRAINER_TOWER                0xAA
#define MAPSEC_CANYON_ENTRANCE              0xAB
#define MAPSEC_SEVAULT_CANYON               0xAC
#define MAPSEC_TANOBY_RUINS                 0xAD
#define MAPSEC_SEVII_ISLE_22                0xAE
#define MAPSEC_SEVII_ISLE_23                0xAF
#define MAPSEC_SEVII_ISLE_24                0xB0
#define MAPSEC_NAVEL_ROCK                   0xB1
#define MAPSEC_MT_EMBER                     0xB2
#define MAPSEC_BERRY_FOREST                 0xB3
#define MAPSEC_ICEFALL_CAVE                 0xB4
#define MAPSEC_ROCKET_WAREHOUSE             0xB5
#define MAPSEC_TRAINER_TOWER_2              0xB6
#define MAPSEC_DOTTED_HOLE                  0xB7
#define MAPSEC_LOST_CAVE                    0xB8
#define MAPSEC_PATTERN_BUSH                 0xB9
#define MAPSEC_ALTERING_CAVE                0xBA
#define MAPSEC_TANOBY_CHAMBERS              0xBB
#define MAPSEC_THREE_ISLE_PATH              0xBC
#define MAPSEC_TANOBY_KEY                   0xBD
#define MAPSEC_BIRTH_ISLAND                 0xBE
#define MAPSEC_MONEAN_CHAMBER               0xBF
#define MAPSEC_LIPTOO_CHAMBER               0xC0
#define MAPSEC_WEEPTH_CHAMBER               0xC1
#define MAPSEC_DILFORD_CHAMBER              0xC2
#define MAPSEC_SCUFIB_CHAMBER               0xC3
#define MAPSEC_RIXY_CHAMBER                 0xC4
#define MAPSEC_VIAPOIS_CHAMBER              0xC5
#define MAPSEC_EMBER_SPA                    0xC6
